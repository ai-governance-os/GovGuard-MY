...
- **pytest** (zero-key env) → **1006 passed / 1 skipped / 0 failed** (1007 collected), incl. the Workflow Autonomy layer (102W/101D), the National Athletics reporting workflow, and the post-main-demo user-input governance probes.
